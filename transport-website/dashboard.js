...
Pages.dashboard = async function() {
  ...
  el.innerHTML = `
    <div>
      <div class="page-header">
        ...
        <div class="avail-toggle" id="dash-avail-toggle">
          <button class="avail-btn" data-status="offline" onclick="setAvailability('offline')">⚫ Offline</button>
          <button class="avail-btn" data-status="available" onclick="setAvailability('available')">🟢 Available</button>
          <button class="avail-btn" data-status="busy" onclick="setAvailability('busy')">🟡 Busy</button>
        </div>
      </div>
  ...
  // Update avail toggle with current status
  if (AppState.driver) updateAvailabilityUI(AppState.driver.status);
      ...
      <div class="stat-card-body">
        <div class="stat-info">
          ...
          <div class="stat-change">
            <span class="badge badge-${status}">${fmtStatus(status)}</span>
          </div>
        </div>
